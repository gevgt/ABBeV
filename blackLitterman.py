...
ticker_name = ["Facebook", "Apple", "Amazon", "Netflix", "Google"]
...
for x,y in zip(tickers, ticker_name):
    d = pdr.DataReader(x, "yahoo", "2015-01-01", "2020-01-01")["Adj Close"]
...
wmarket = np.array([0.14, 0.35, 0.29, 0.04, 0.19]).reshape(5,1)
